...
generate-spectrogram: analysis/generate-spectrogram.c spectrogram.c graphing.c image_io.c sound_io.c windowing.c
	gcc -o generate-spectrogram analysis/generate-spectrogram.c spectrogram.c graphing.c image_io.c sound_io.c windowing.c -lm -lfftw3 -lpng -I.
